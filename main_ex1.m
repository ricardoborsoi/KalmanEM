% =========================================================================
% Run methods for synthetic example 1
% 
...
% load dataset
load ../../BFHI/baselines_VRNN/synth_dataset_ex1.mat
...
try 
    load('endmembers_vca_synth_ex1.mat','M0')
    Mth=M;
catch
    ...
    save('endmembers_vca_synth_ex1.mat','M0')
end
...
for t=1:T
    ...
    A_cube = permute(A(:,:,:,t),[2,3,1]);
    axes(ha(0*T + t));
    imagesc(A_cube,[0 1]), set(gca,'ytick',[],'xtick',[])
